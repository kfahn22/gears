...
const a = 1;
const b = 4;
let sc = 50; // scale // changed to 80 for canvas dim (800, 400)
let m = 6; // number of spokes
let angle = 0;
let w = 50; // changed to 80 for canvas dim (800, 400)
let cols;
let rows;
let inc = -1;
let frames = 60;
...
function draw() {
  ...
  const w = width / 10; //changed to for canvas dim (800, 400)
